...
async function loadExams() { const r = await examApi.list(); exams.value = r.data as any }
async function loadClasses() { const r = await schoolApi.listClasses(); classes.value = r.data as any }
